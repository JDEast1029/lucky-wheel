...
var LuckWheel = /** @class */ (function () {
    ...
    LuckWheel.prototype.start = function () {
    ...
    LuckWheel.prototype.init = function () {
        var _a = this.config, speedUpCubicBezier = _a.speedUpCubicBezier, speedCutCubicBezier = _a.speedCutCubicBezier, offsetDegree = _a.offsetDegree, maxRotateSpeed = _a.maxRotateSpeed, direction = _a.direction;
        ...
        this.maxRotateSpeed = direction === LuckWheelTypes_1.DirectionType.ANTICLOCKWISE ? -maxRotateSpeed : maxRotateSpeed;
    };
    ...
    LuckWheel.prototype.stopBufferAnimate = function (step, targetDegree) {
    ...
    LuckWheel.prototype.cancelAnimate = function (animateIDs) {
        if (animateIDs === 'all') {
